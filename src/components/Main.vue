<template>
    <el-container>
        <el-header style="background-color: #B3C0D1;color: #333;">
            <h1>Java 异常类生成器</h1>
        </el-header>
        <el-main>
            <el-container>
                <el-aside style="background: #EBEEF5">
                    ...
                    <el-tree :data="config.exceptions" :props="{'label':'exceptionName','children':'subException'}"></el-tree>
                </el-aside>
                <el-main>
                    <h3>配置项</h3>
                            ...
                            <div>
                                ...
                                <el-form :inline="true">
                                    <el-form-item label="包" size="small">
                                        <el-input v-model="temp.editExceptionCache.config.package"/>
                                    </el-form-item>
...
export default {
    ...
    methods: {
        generate(){
            ...
            configData.predefine = this.predefine;

            configUtil.generate(configData)
        },
