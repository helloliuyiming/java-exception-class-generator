export let template =
`{%if config.package != null %}package {{config.package}}; {% endif %}

public{%if final %} final{% endif %} class {{exceptionName}} extends {{parentException}}{
    ...
    public {{exceptionName}} ({% for field in fields %} {%if loop.index>1 %} ,{% endif %}{{field.type}} {{field.field}} {% endfor %}){
        super(message);
        {% for field in fields %}
